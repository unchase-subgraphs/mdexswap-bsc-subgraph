...
export function handlePairCreated(event: PairCreated): void {
  ...
  //
  // - contract.FEE_RATE_DENOMINATOR(...)
  // - contract.addPair(...)
  // - contract.allPairs(...)
  // - contract.allPairsLength(...)
  // - contract.createPair(...)
  // - contract.delPair(...)
  // - contract.feeRateNumerator(...)
  // - contract.feeTo(...)
  // - contract.feeToRate(...)
  ...
  // - contract.getPair(...)
  // - contract.getPairFees(...)
  // - contract.getPairRate(...)
  // - contract.getReserves(...)
  // - contract.getSupportListLength(...)
  // - contract.getSupportPair(...)
  // - contract.initCodeHash(...)
  // - contract.isSupportPair(...)
  // - contract.pairFeeToRate(...)
  // - contract.pairFees(...)
  // - contract.pairFor(...)
  // - contract.quote(...)
  // - contract.sortTokens(...)
